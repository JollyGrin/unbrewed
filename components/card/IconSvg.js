...
export default class IconSvg extends Component {
  ...
  actions = {
    params: () => {
      return this.typeData(this.iconDetails.cardType);
    },
    height: () => {
      return this.iconDetails.width * typeData[this.cardType].heightRatio;
    },
    transform: () => {
      return `translate(${this.iconDetails.x} ${this.iconDetails.y}) scale(${
        this.iconDetails.width
      }) translate(${this.actions.params().xAdjust} 0)`;
    },
  };
  ...
  typeData = (typeOfCard) => {
    ...
    switch (typeOfCard) {
      case 'attack':
        return setTypes.attack;
      case 'defence':
        return setTypes.defence;
      case 'versatile':
        return setTypes.versatile;
      case 'scheme':
        return setTypes.scheme;
    }
  };

  renderIcon = () => {
    switch (this.iconDetails.cardType) {
      case 'attack':
        return this.renderDom.attack();
      case 'defence':
        return this.renderDom.defence();
      case 'versatile':
        return this.renderDom.versatile();
      case 'scheme':
        return this.renderDom.scheme();
    }
  };
